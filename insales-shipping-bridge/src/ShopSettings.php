...
final class ShopSettings
{
    ...
    public function __construct(
        ...
        public readonly ?string $derivalTimeFrom,
        public readonly ?string $derivalTimeTo,
        public readonly ?string $derivalBreakFrom,
        public readonly ?string $derivalBreakTo,
    ...
    public static function fromRow(array $row): self
    {
        ...
        return new self(
            ...
            derivalTimeFrom: self::nullableString($row['derival_time_from'] ?? null),
            derivalTimeTo: self::nullableString($row['derival_time_to'] ?? null),
            derivalBreakFrom: self::nullableString($row['derival_break_from'] ?? null),
            derivalBreakTo: self::nullableString($row['derival_break_to'] ?? null),
